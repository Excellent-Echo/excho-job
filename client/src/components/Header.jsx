              ...
              <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
                ...
                <div className="py-6 px-5 space-y-6">
                  <div>
                    ...
                    <span className="w-full mt-4 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border rounded-md shadow-sm text-base font-medium text-indigo-600">
                      For Company
                      <svg
